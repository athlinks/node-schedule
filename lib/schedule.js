...
Job.prototype.schedule = function(spec) {
  ...
  if (spec !== null && typeof spec === 'object' && spec !== null && spec.hasOwnProperty('tz')) {
    tz = spec.tz;
  }

  if (spec !== null && typeof spec === 'object' && spec.rule) {
  ...
  try {
    ...
    if ((spec instanceof Date) && (isValidDate(spec))) {
      ...
      if (!(spec instanceof RecurrenceRule)) {
        ...
        if (spec !== null && spec.hasOwnProperty('year')) {
          r.year = spec.year;
        }
        if (spec !== null && spec.hasOwnProperty('month')) {
          r.month = spec.month;
        }
        if (spec !== null && spec.hasOwnProperty('date')) {
          r.date = spec.date;
        }
        if (spec !== null && spec.hasOwnProperty('dayOfWeek')) {
          r.dayOfWeek = spec.dayOfWeek;
        }
        if (spec !== null && spec.hasOwnProperty('hour')) {
          r.hour = spec.hour;
        }
        if (spec !== null && spec.hasOwnProperty('minute')) {
          r.minute = spec.minute;
        }
        if (spec !== null && spec.hasOwnProperty('second')) {
